...
{
    #[Route('Agence/admin/mod_agent', name: 'mod_agent')]
    ...
    #[Route('Agence/admin/mod_agent/{id}/{cat}', name: 'agent_mod',requirements: ['id' => '\d+'])]
    public function agentMod(int $id,string $cat): Response
    {
        ...
        if($cat === 'name')
        {
            if(isset($_POST['agent']['name']))
            {
                ...
                return $this->redirect('/Agence/admin/mod_agent/'.$id);
            }
        }
        if($cat === "firstName")
        {
    ...
    #[Route('Agence/admin/mod_agent/{id}', name: 'agent_detail',requirements: ['id' => '\d+'])]
    ...
    #[Route('Agence/admin/mod_speciality', name: 'mod_speciality')]
    ...
    #[Route('Agence/admin/mod_hideout', name: 'mod_hideout')]
    ...
    #[Route('Agence/admin/mod_contact', name: 'mod_contact')]
    ...
    #[Route('Agence/admin/mod_target', name: 'mod_target')]
    ...
    #[Route('Agence/admin/mod_mission', name: 'mod_mission')]
    ...
    #[Route('Agence/admin/mod_mission/{id}', name: 'mod_mission_detail', requirements: ['id' => '\d+'])]
