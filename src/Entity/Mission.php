...
class Mission
{
    ...
    public function getRequireSpeciality(): ?Speciality
    {
        return $this->requireSpeciality;
    }

    public function setRequireSpeciality(?Speciality $requireSpeciality): self
    {
        $this->requireSpeciality = $requireSpeciality;
